...
* **감사가능성:** Vyper 코드는 최대한 인간친화적이어야한다. 또한, 최대한 오해 할만한 코드를 쓰는 것을 최대한 막을 수 있어야한다. 코드 해석의 간결성은 코드 작성의 간셜성보다 중요하다.
...
* **이진 고정 소수점:** 십진 고정 소수점이 더 낫습니다. 그 이유는 코드에 쓰인 그대로의 값을 지니기 때문입니다. 이진 고정 소수점의 경우 버림이 종종 필요한데 (e.g. (0.2) :sub:`10` = (0.001100110011...)\ :sub:`2`, 언젠가는 짤림)
